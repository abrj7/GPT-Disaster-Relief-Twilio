exports.handler = function(context, event, callback) {
    ...
    if (!event.request.cookies.convo) {
        ...
        twiml.say({
            ...
            "Hello, there is a Typhoon about to occur in your area, I'm Chat GPT an AI assistant that is going to aid you during this process, could you tell me your location?"
        );
    }
