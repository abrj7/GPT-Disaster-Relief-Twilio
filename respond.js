...
exports.handler = async function(context, event, callback) {
    ...
    function formatConversation(conversation) {
        ...
        const messages = [{
                role: "system",
                content: "You are a voice assistant helping victims of a Typhoon in the Philippines to provide them advice on how to keep safe and gather data about their location.",
            },
            {
                role: "user",
                content: "We are having a conversation over the telephone so please provide engaging but concise responses.",
            },
        ];
